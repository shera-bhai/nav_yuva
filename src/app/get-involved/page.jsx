      ...
      <div id="volunteer" className="py-16 bg-white cursor-default">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            ...
            <Link href="/contact" className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-xl shadow-gray-300 hover:text-white hover:bg-cyan-500 bg-gray-200 transition-all duration-300 ease-in-out">
