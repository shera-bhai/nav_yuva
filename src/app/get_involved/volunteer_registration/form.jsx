...
export default function VolunteerRegistrationPage() {
  ...
  const handleInputChange = (e) => {
    ...
    if (type === 'checkbox') {
      if (name === 'terms' || name === 'receiveUpdates') {
          ...
          <div className="py-4 px-4 sm:px-10">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">
                Your Volunteer Application Has Been Recieved By Our Team
              </h3>
              ...
              <div className="bg-gray-100 p-4 rounded-lg mb-6">
                ...
                <ol className="list-decimal text-left pl-5 text-gray-600 space-y-2">
                  ...
                  <li>You'll receive an email confirmation with your application status soon.</li>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative bg-black cursor-default">
        <div className="h-40 md:h-44">
          <Image
            src="/assets/get_involved/volunteer.jpg"
            alt="Volunteer with N.A.V Yuva Foundation"
            fill
            className="object-cover brightness-110 opacity-70"
            priority
          />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="px-4 py-5 sm:p-6 space-y-8">
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-2 items-center mt-1">
                  ...
                  <p className="text-sm text-gray-500">
                    ...
                    <Link href="https://drive.google.com/file/d/1d5Vu5xzmu6mhuEjN3wqbQtDlfPG3n55x/view?usp=sharing" target='_blank' className='underline'>terms and conditions</Link>.
                  </p>
                </div>
                  {formErrors.terms && (
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="inline-flex justify-center py-2 px-4 border border-gray-200 rounded-md shadow-sm text-sm font-medium hover:bg-[#23c5ca] hover:text-white transition duration-300 ease-in-out"
              >
                Submit Application
              </button>
            </div>
